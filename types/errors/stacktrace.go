...
func trimInternal(st errors.StackTrace) errors.StackTrace {
	...
	for matchesFunc(st[0],
		...
		"github.com/dbchaincloud/cosmos-sdk/types/errors.Wrap",
		"github.com/dbchaincloud/cosmos-sdk/types/errors.Wrapf",
		"github.com/dbchaincloud/cosmos-sdk/types/errors.WithType",
