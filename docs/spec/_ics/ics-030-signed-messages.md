...
JSON representation as defined [here](https://github.com/dbchaincloud/tendermint/blob/master/types/canonical.go).
...
allowed to sign bytes of valid ASCII text ([see here](https://github.com/dbchaincloud/tendermint/blob/master/libs/common/string.go#L61-L74)).
