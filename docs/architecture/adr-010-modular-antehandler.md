...
- [#4572](https://github.com/dbchaincloud/cosmos-sdk/issues/4572):  Modular AnteHandler Issue
- [#4582](https://github.com/dbchaincloud/cosmos-sdk/pull/4583): Initial Implementation of Per-Module AnteHandler Approach
