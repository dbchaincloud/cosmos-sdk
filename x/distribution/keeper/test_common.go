...
var (
	...
	valOpPk1    = algo.GenPrivKey().PubKey()
	valOpPk2    = algo.GenPrivKey().PubKey()
	valOpPk3    = algo.GenPrivKey().PubKey()
	...
	valConsPk1   = algo.GenPrivKey().PubKey()
	valConsPk2   = algo.GenPrivKey().PubKey()
	valConsPk3   = algo.GenPrivKey().PubKey()
